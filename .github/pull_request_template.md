...
- [ ] Requer migração de dados (Flyway)
- [ ] Requer mudança de configuração / secrets
- [ ] Afeta contrato externo (API / webhook / Kafka topic)
...
- [ ] Testes de integração quando há I/O (DB / Kafka / Redis / HTTP externo)
- [ ] ArchUnit continua passando (camadas hexagonais respeitadas)
- [ ] Logs estruturados com `traceId` quando aplicável
