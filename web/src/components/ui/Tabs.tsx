...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center gap-1 rounded-lg border border-border/60 bg-card p-1 shadow-sm",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=inactive]:text-muted-foreground hover:data-[state=inactive]:bg-muted/60 hover:data-[state=inactive]:text-foreground",
      className,
    )}
    {...props}
  />
