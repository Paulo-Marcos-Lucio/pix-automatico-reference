...
Release de manutenção: migração de major para Spring Boot 4 e atualização
do backlog inteiro de dependências (junho/2026). Sem mudanças de contrato
público; 48 testes verdes (38 unit + 10 integração via Testcontainers).
...
[Unreleased]: https://github.com/Paulo-Marcos-Lucio/pix-automatico-reference/compare/v0.3.1...HEAD
[0.3.1]: https://github.com/Paulo-Marcos-Lucio/pix-automatico-reference/compare/v0.3.0...v0.3.1
